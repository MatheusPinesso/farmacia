(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/scrolling'), require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('@angular/forms'), require('primeng-lts/tooltip'), require('primeng-lts/ripple')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/dropdown', ['exports', '@angular/cdk/scrolling', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/utils', '@angular/forms', 'primeng-lts/tooltip', 'primeng-lts/ripple'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].dropdown = {}), global.ng.cdk.scrolling, global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].dom, global['primeng-lts'].utils, global.ng.forms, global['primeng-lts'].tooltip, global['primeng-lts'].ripple));
...
//# sourceMappingURL=primeng-lts-dropdown.umd.js.map
