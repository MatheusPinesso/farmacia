...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DataView, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.ChangeDetectorRef }]; }, { pageLinks: [{
            type: Input
        }], paginatorPosition: [{
            type: Input
        }], alwaysShowPaginator: [{
...
DataViewModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, SharedModule, PaginatorModule], SharedModule] });
...
//# sourceMappingURL=primeng-lts-dataview.js.map